...
# Introduction
This package currently provides one function, `parse_reaction_table`, which taks a metabolic model as a data frame, and outputs it in a format suitable for input the the Gurobi Linear Programming library.
